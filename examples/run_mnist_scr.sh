...
## CONFIG ##
DATASET="mnist"
CONSTRAINT="StrongClassificationRobustness"
EXPERIMENT_NAME="strong-classification-robustness"
...
LOGICS=("QLL_5" "STL_5" "DL2" "Baseline")
EPS_VALUES=("0.1" "0.2")
...
verify() {
    ...
    local images="mnist-images-100.idx"
    local labels="mnist-labels-100.idx"
